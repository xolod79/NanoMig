/*
    top.sv - NanoMig on Lattice/IceSugar-Pro

	
	openFPGALoader -cft231X --pins=7:3:5:6 lattice/icesugar-pro/impl/nanomig_impl.bit 
...
//  inout [27:0]	gpio,
  ...
  // hdmi/tdms
  output [7:0]	TMDS    // negative seems to be mapped implicitely
);
...
wire [15:0] spi_sclk_D = { spi_sclk_D[14:0], spi_io_clk } /* synthesis syn_keep=1 */ /* synthesis syn_dont_touch=1 */;
...
`define PIXEL_CLOCK 28333333 // should be 28375160
...
pll_142m pll_142m (
	.CLKI( clk ),               // 25Mhz in
	.CLKOP( clk_pixel_x5),      // 141,666 Mhz
	.CLKOS( clk_85m ),          // 85 Mhz
	.CLKOS2( clk_85m_shifted ), // 85 Mhz shifted by 216° 
	.CLKOS3( clk_pixel ),       // 28,333333 Mhz
    .LOCK( pll_lock )
);
